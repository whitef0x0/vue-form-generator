<template lang="jade">
	input.form-control(:field="schema.model",v-validate="schema.validation",type="text", v-model="value", :readonly="schema.readonly", :disabled="disabled", :placeholder="schema.placeholder")
</template>
